...
public class FileDrop {
   ...
   public FileDrop(Component c, Listener listener) {
      this((PrintStream)null, c, BorderFactory.createMatteBorder(2, 2, 2, 2, defaultBorderColor), true, listener);
   }

   public FileDrop(Component c, boolean recursive, Listener listener) {
      this((PrintStream)null, c, BorderFactory.createMatteBorder(2, 2, 2, 2, defaultBorderColor), recursive, listener);
   }
   ...
   public FileDrop(Component c, Border dragBorder, Listener listener) {
      this((PrintStream)null, c, dragBorder, false, listener);
   }

   public FileDrop(Component c, Border dragBorder, boolean recursive, Listener listener) {
      this((PrintStream)null, c, dragBorder, recursive, listener);
   }
   ...
   private void makeDropTarget(final PrintStream out, final Component c, boolean recursive) {
      ...
      c.addHierarchyListener(new HierarchyListener() {
         public void hierarchyChanged(HierarchyEvent evt) {
            ...
            if (parent == null) {
               c.setDropTarget((DropTarget)null);
   ...
   public static boolean remove(Component c) {
      return remove((PrintStream)null, c, true);
   }
