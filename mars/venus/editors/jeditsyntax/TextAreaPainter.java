...
public class TextAreaPainter extends JComponent implements TabExpander {
   ...
   public TextAreaPainter(JEditTextArea textArea, TextAreaDefaults defaults) {
      ...
      this.setFont(new Font("Lucida Sans Typewriter", 0, 14));
      if(Globals.getSettings().getBooleanSetting(21))
         this.textArea.setForeground(new Color(0xffffff  ));
   ...
   public String getToolTipText(MouseEvent evt) {
      if (this.highlights != null) {
         ...
         return this.textArea.getTokenMarker() == null ? null : this.textArea.getSyntaxSensitiveToolTipText(evt.getX(), evt.getY());
      }
   }
   ...
   public void paint(Graphics gfx) {
      ...
      try {
         TokenMarker tokenMarker = ((SyntaxDocument)this.textArea.getDocument()).getTokenMarker();
   ...
   public interface Highlight {
      void init(JEditTextArea var1, Highlight var2);
