...
class Magnifier extends JFrame implements ComponentListener {
   ...
   Magnifier() {
      ...
      this.close.setToolTipText("Exit the Screen Magnifier.  Changed settings are NOT retained.");
      ...
      this.settings.setToolTipText("Show dialog for changing tool settings.");
      ...
      this.capture.setToolTipText("Capture, scale, and display pixels that lay beneath the Magnifier.");
      ...
      SpinnerModel scaleModel = new SpinnerNumberModel(2.0, 1.0, 4.0, 0.5);
      this.scaleAdjuster = new JSpinner(scaleModel);
      this.scaleAdjuster.setToolTipText("Magnification scale for captured image.");
      JSpinner.NumberEditor scaleEditor = new JSpinner.NumberEditor(this.scaleAdjuster, "0.0");
   ...
   BufferedImage captureScreenSection(Rectangle section) {
      ...
      BufferedImage imageOfSection = robot.createScreenCapture(section);
      this.setVisible(true);
